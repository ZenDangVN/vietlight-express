...
final class BdevsElementor {
	...
	public function admin_notice_missing_main_plugin() {
		...
		$message = sprintf(
			...
			'<strong>' . esc_html__( 'Logtra Elementor', 'bdevs-elementor' ) . '</strong>',
	...
	public function add_elementor_category() {
    	\Elementor\Plugin::instance()->elements_manager->add_category('bdevs-elementor',
	      	array(
					'title' => __( 'Logtra Elementor', 'bdevs-elementor' ),
					'icon'  => 'fa fa-plug',
	      	) 
	    );
	}
	...
	*/
	...
	public function init_widgets() {
		...
		require_once plugin_dir_path( __FILE__ ) . 'widgets/project-details-widget.php';
		require_once plugin_dir_path( __FILE__ ) . 'widgets/project-details-2-widget.php';
		require_once plugin_dir_path( __FILE__ ) . 'widgets/service-details-widget.php';
		...
		require_once plugin_dir_path( __FILE__ ) . 'widgets/project-widget.php';
		...
		require_once plugin_dir_path( __FILE__ ) . 'widgets/cta-2-widget.php';
		require_once plugin_dir_path( __FILE__ ) . 'widgets/blog-widget.php';
		require_once plugin_dir_path( __FILE__ ) . 'widgets/banner-2-widget.php';
		require_once plugin_dir_path( __FILE__ ) . 'widgets/about-2-widget.php';
		require_once plugin_dir_path( __FILE__ ) . 'widgets/project-2-widget.php';
		require_once plugin_dir_path( __FILE__ ) . 'widgets/counter-widget.php';
		require_once plugin_dir_path( __FILE__ ) . 'widgets/testimonial-2-widget.php';
		...
		require_once plugin_dir_path( __FILE__ ) . 'widgets/page-header-widget.php';

		// Register widget
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \BdevsElementor\Widget\BdevsProjectDetails() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \BdevsElementor\Widget\BdevsProjectDetails2() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \BdevsElementor\Widget\BdevsServiceDetails() );
		...
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \BdevsElementor\Widget\BdevsProject() );
		...
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \BdevsElementor\Widget\BdevsCTA2() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \BdevsElementor\Widget\BdevsBlog() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \BdevsElementor\Widget\BdevsBanner2() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \BdevsElementor\Widget\BdevsAbout2() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \BdevsElementor\Widget\BdevsProject2() );
		...
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \BdevsElementor\Widget\BdevsPageHeader() );
	}
