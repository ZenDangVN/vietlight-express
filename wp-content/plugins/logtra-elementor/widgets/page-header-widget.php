 ...
 * @since 1.0.0
 */
class BdevsPageHeader extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return __( 'Page Header', 'bdevs-elementor' );
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Page Header', 'bdevs-elementor' ),
            ]   
        );
        $this->add_control(
            'banner_image',
    ...
    extract($settings); ?>
    <div class="site-breadcrumb" style="background: url(<?php echo wp_kses_post($settings['banner_image']['url']); ?>)">
            <div class="container">
                <div class="site-breadcrumb-wpr">
                    <?php if ( $settings['show_heading'] ) : ?>
                    <h2 class="breadcrumb-title"><?php print wp_kses_post($settings['heading']); ?></h2>
                    <?php endif; ?>
                    <ul class="breadcrumb-menu clearfix">
                        ...
                        <li class="active"><?php print wp_kses_post($settings['current_page']); ?></li>
                        <?php } ?>
                    </ul>
                </div>
            </div>
