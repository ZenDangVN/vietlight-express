...
class BdevsProjectDetails2 extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return __( 'Project Details 2', 'bdevs-elementor' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Project Details 2', 'bdevs-elementor' ),
            ]   
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => __( 'Web design Overview for IT Company ', 'bdevs-elementor' ),
                'label_block' => true,
            ]
        );
        $this->add_control(
    ...
    public function render() {
        ...
        <div class="project-single-desc">
            <div class="project-single-ele grid-2 align-items-center">
                ...
                <img src="<?php print wp_kses_post($settings['detail_image']['url']);?>" class="pl-50" alt="no image">
                <?php } ?>
            </div>
        </div>
    <?php
