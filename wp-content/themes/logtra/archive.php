        ...
        <div class="container">
            <div class="site-breadcrumb-wpr">
                <h2 class="breadcrumb-title"><?php
                    if ( is_day() ) :
                        printf( esc_html__( 'Daily Archives: %s', 'logtra' ), get_the_date() );
                    elseif ( is_month() ) :
                        printf( esc_html__( 'Monthly Archives: %s', 'logtra' ), get_the_date( _x( 'F Y', 'monthly archives date format', 'logtra' ) ) );
                    elseif ( is_year() ) :
                        printf( esc_html__( 'Yearly Archives: %s', 'logtra' ), get_the_date( _x( 'Y', 'yearly archives date format', 'logtra' ) ) );
                    else :
                        echo esc_html__( 'Archives', 'logtra' );
                    endif; ?></h2>
                <ul class="breadcrumb-menu clearfix">
                    ...
                    <li class="active"><?php echo esc_html__( 'Archives', 'logtra' );?></li>
                </ul>
            </div>
        </div>
    </div>
